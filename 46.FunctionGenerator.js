...
const names = createNames(); // seakan-akan mirip seperti array, namun hanya bisa di iterasa dan tidak bisa di akses secara index
console.log(names); // coba di console browser untuk detilnya
for (const name of names) { // bisa di iterasi
    console.log(name);
}
console.log("---------------------");
